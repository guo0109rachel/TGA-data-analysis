...
% Parameters
n_cycle=5; % number of redox cycles
...
data=readtable([PathName,FileName],'FileType','text','Delimiter','\t','HeaderLines',11);
...
newFileName=strrep(FileName,FileName((end-3):end),'_handled.xlsx');
